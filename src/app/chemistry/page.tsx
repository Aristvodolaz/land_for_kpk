...
import { chemistryCourse } from '@/data/courses'
    ...
    <>
      ...
      <section className={styles.hero}>
        <div className="container">
          ...
          <h1 className={styles.heroTitle}>{chemistryCourse.title}</h1>
          <p className={styles.heroSubtitle}>{chemistryCourse.description}</p>
      ...
      <section id="program" className="section">
        <div className="container">
          ...
          {chemistryCourse.modules.map((module) => (
      ...
      <section id="speakers" className="section">
        <div className="container">
          ...
          <div className={styles.speakersGrid}>
            {chemistryCourse.speakers.map((speaker, index) => (

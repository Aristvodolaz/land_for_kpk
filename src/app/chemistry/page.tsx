...
export const metadata = {
  title: 'Курсы повышения квалификации для учителей химии — КПК',
      ...
      <section className={styles.hero}>
        <div className="container">
          <div className={styles.breadcrumbs}>
            <Link href="/">Главная</Link> / <span>Химия</span>
          </div>
          <h1 className={styles.heroTitle}>Курсы повышения квалификации для учителей химии</h1>
          <p className={styles.heroSubtitle}>
            Три направления подготовки: олимпиадная работа, подготовка к ЕГЭ и углубленное преподавание химии.
          </p>
